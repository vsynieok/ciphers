...
import SimpleRearragement from "../../ciphers/SimpleRearragement";

const RearragementAlgo: React.FC = () => {
  ...
  let onSubmit = (v: any) => {
    try {
      let encryptor = new SimpleRearragement(v.cryptoKey ?? undefined);
  ...
  return (
    ...
    >
      <Card title="Проста перестановка" style={{ margin: "100px" }}>
        <Form
...
export default RearragementAlgo;
