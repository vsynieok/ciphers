...
import SimpleReplacement from "../../ciphers/SimpleReplacement";

const ReplacementAlgo: React.FC = () => {
  ...
  let onSubmit = (v: any) => {
    try {
      let encryptor = new SimpleReplacement(v.cryptoKey ?? undefined);
  ...
  return (
    ...
    >
      <Card title="Проста заміна" style={{ margin: "100px" }}>
        <Form
